...
namespace Dubuche.DAD
{
    ...
    public partial class TSQLEntities : DbContext
    {
        ...
        [DbFunction("TSQLEntities", "GetNums")]
        public virtual IQueryable<GetNums_Result> GetNums(Nullable<long> low, Nullable<long> high)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetNums_Result>("[TSQLEntities].[GetNums](@low, @high)", lowParameter, highParameter);
        }
